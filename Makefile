...
game: game.c battle-horizon.c defs.h ui.c translate.c linked_list.c array.c ai/neural_img.o
	cc game.c ai/neural_img.o -o game $(LDFLAGS) $(CFLAGS) 
editor: editor.c linked_list.c battle-horizon.c defs.h
...
x86_64-w64-battle-horizon.exe: game.c battle-horizon.c defs.h ui.c translate.c linked_list.c array.c ai/x86_64-w64-neural.o
	x86_64-w64-mingw32-gcc -o x86_64-w64-battle-horizon.exe game.c ai/x86_64-w64-neural.o -Iraylib-4.6-dev_win64_mingw-w64/include/ -Lraylib-4.6-dev_win64_mingw-w64/lib/ -IOpenBLAS-0.3.24-x64/include -LOpenBLAS-0.3.24-x64/lib/ -lraylib -lwinmm -lgdi32 -lopenblas -static -Wall -Wno-implicit -O3
